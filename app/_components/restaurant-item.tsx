    ...
    return <div className="min-w-[266px] max-w-[266px] space-y-3">
        <div className="w-full h-[136px] relative">
            <Image src={restaurant.imageUrl} fill className="object-cover rounded-lg" alt={restaurant.name}/>
                ...
                <div className="absolute top-2 left-2 bg-primary py-[2px] px-2 rounded-full flex items-center gap-[2px] bg-white ">
                    <StarIcon size={12} className="fill-yellow-500 text-yellow-500"/>
                    <span className="font-semibold text-xs">5.0</span>
                </div>

                <Button className="absolute right-2 top-2 bg-gray-700 rounded-full h-7">
